// Package errors provides centralized error handling for dsaprep
package errors
...
var Registry = map[string]*AppError{
	ErrEnvMissing: {
		...
		Suggestion:  "Run 'dsaprep init' to create configuration",
		Recoverable: true,
	...
	ErrEnvCorrupt: {
		...
		Suggestion:  "Delete ~/.dsaprep.env and run 'dsaprep init'",
		Recoverable: true,
		Action:      ActionAutoFix,
	},
	ErrHandleNotSet: {
		...
		Suggestion:  "Set CF_HANDLE in ~/.dsaprep.env",
		Recoverable: false,
	...
	ErrCredentialsMissing: {
		...
		Suggestion:  "Set CF_API_KEY and CF_API_SECRET in ~/.dsaprep.env",
		Recoverable: false,
		Action:      ActionUserPrompt,
	},
	ErrSessionExpired: {
	...
	ErrCFWebChanged: {
		...
		Suggestion:  "Please update dsaprep to the latest version",
		Recoverable: false,
	...
	ErrCFLoginFailed: {
		...
		Suggestion:  "Check your credentials in ~/.dsaprep.env",
		Recoverable: true,
		Action:      ActionUserPrompt,
	},
	ErrSchemaIncompatible: {
		...
		Suggestion:  "Run 'dsaprep migrate' to upgrade",
		Recoverable: true,
		Action:      ActionUserPrompt,
	},
	ErrWorkspaceNotFound: {
		...
		Suggestion:  "Run 'dsaprep init' in your workspace directory",
		Recoverable: true,
		Action:      ActionAutoFix,
	},
	ErrNetworkOffline: {
